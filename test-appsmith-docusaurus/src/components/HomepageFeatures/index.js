...
const FeatureList = [
  {
    title: <a href="/test-appsmith-docusaurus/getting-started/start-building">Quick Start</a>,
  ...
  {
    title: <a href="/test-appsmith-docusaurus/getting-started/setup">Deploy Appsmith</a>,
